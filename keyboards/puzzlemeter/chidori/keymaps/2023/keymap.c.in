...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_QWERTY] = LAYOUT(
      ...
      KC_LGUI, KC_LALT,  KC_LCTL, LSFT_T(KC_ESC),LT(1,KC_TAB),LT(3,KC_SPC),    KC_BSPC, LT(2,KC_SCLN),KC_LEFT,  KC_DOWN,     KC_UP,  KC_RIGHT
    ),
  ...
  */
    [_LOWER] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,          TO(2),   _______, _______,     _______,   _______, _______
    ),

  /* Raise
   * ,-------------------------------------------.             ,-------------------------------------------.
   * | Esc  |LOCK  |   1  |   2  |   3  |    _   |             |   -  |   [  |  Up  |  ]   |TEST_ACT| Bksp |
   * |------|------+------+------+------+--------|             |------+------+------+------+--------+------|
   * | Ctrl | \    |   4  |   5  |   6  |TD_EMAIL|             |   :  | LEFT | Down |  [   |C_DOMAIN|Enter |
   * |------|------+------+------+------+--------|             |------+------+------+------+--------+------|
   * |Shift | `~   |   7  |   8  |   9  |   0    |             |  TO  | Full | Pgup | Pgup | ARROW  |   \  |
   * |      |      |      |      |      |        |             |QWERTY| Name |      |      |        |      |
   * |------|------+------+------+------+--------|             |------+------+------+------+--------+------|
   ...
   */
    [_RAISE] = LAYOUT(
      _______,   LOCKMAC,    KC_1,    KC_2,   KC_3,   S(KC_MINS),            KC_MINS, KC_LBRC,     KC_UP,  KC_RBRC, TEST_ACT,   KC_BSPC,
      _______, KC_BSLS,    KC_4,    KC_5,   KC_6, TD(TD_EMAIL),         S(KC_SCLN), KC_LEFT,   KC_DOWN,  KC_RGHT, C_DOMAIN,    KC_ENT,
      _______,  KC_GRV,    KC_7,    KC_8,   KC_9,         KC_0,         TO(0),  FULL_NAME,   KC_PGUP,  KC_PGDN, TD(TD_ARR),KC_BSLS,
      _______, _______, _______, _______,_______,   TD(TD_IME),        TO(1),  _______, _______, _______, _______, _______
    ),
