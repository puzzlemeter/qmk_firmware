...
[_WINMAP] = LAYOUT_ortho_4x12( \
  ...
  KC_LSFT,    KC_Z,   KC_X,   KC_C,  KC_V,   KC_B,     KC_N,   KC_M, KC_COMM,  KC_DOT,       KC_UP, KC_SLSH,  \
  KC_LCTL, KC_LALT, KC_TAB, WINSYM, _______, KC_SPC,   KC_SPC,  _______, KC_ZKHK, KC_LEFT,     KC_DOWN, KC_RIGHT  \
),
/* WINJP_SYM
 * ,-------------------------------------------------------------------------------------.
 * |   ~  |   !  |   @  |    #  |   $  |   %  |   ^  |   &   |   *  |   (  |   )  | Bksp |
...
[_WINSYM] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTL, KC_LALT,  KC_TAB,  KC_LGUI,   _______,   KC_SPC,    KC_SPC,   _______, TD(TT_JLINE), _______, _______, _______  \
),
