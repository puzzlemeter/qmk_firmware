...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_universal(
    ...
    KC_LGUI, KC_LALT,  KC_LCTL, LSFT_T(KC_ESC),LT(1,KC_TAB),LT(3,KC_SPC),    KC_BSPC, LT(2,KC_SCLN),   _______,  _______,_______,      KC_LNG2
  ),

  LAYOUT_universal(
    S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5),                                    S(KC_6),      S(KC_7),       S(KC_8),     S(KC_9),   S(KC_0),
    KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,                                     KC_F6,    S(KC_EQL),        KC_EQL,    KC_LBRC,   KC_RBRC,
    KC_F6,    KC_F7,   KC_F8,   KC_F9,  KC_F10,                                     KC_F12,   S(KC_BSLS), KC_MINS  , KC_QUOT  , KC_RSFT   ,
    _______, _______, _______, _______, _______, _______,                  TO(2) ,  TO(0)    , _______  , KC_RALT  , KC_RGUI  , S(KC_QUOT)
  ),

  LAYOUT_universal(
    KC_GRV,    KC_1,    KC_2,     KC_3,   S(KC_MINS),                               KC_MINS,    KC_BTN1,     KC_UP,  KC_BTN2, KC_KB_MUTE,
    KC_BSLS,   KC_4,    KC_5,     KC_6,   S(KC_SCLN),                               TO(4),    KC_LEFT,   KC_DOWN,  KC_RIGHT, LGUI(LCTL(KC_Q)),
    LGUI(LSFT(KC_4)),  KC_7,    KC_8,     KC_9,        KC_0,                     RCTL(KC_LEFT),  RCTL(KC_RIGHT),   KC_PGUP,  KC_PGDN, _______  ,
    _______, _______, _______, _______,   _______, _______,                TO(1),  _______ , _______ , _______ , _______ , KC_LNG1
  ),

  LAYOUT_universal(
    RGB_TOG  , LCTL(KC_LEFT), LCTL(KC_UP), LCTL(KC_RIGHT), LGUI(KC_A),                RGB_M_P  , RGB_M_B  , RGB_M_R  , RGB_M_SW , RGB_M_SN ,
  ...
  LAYOUT_universal(
    ...
    _______  , _______, KC_MY_BTN2, KC_MY_SCR, KC_MY_BTN1,                              _______  ,KC_MY_BTN1, KC_MY_SCR, KC_MY_BTN2  , _______  ,
    _______  , _______  , _______  , _______  , _______,                              _______  , _______  , _______  , _______  , _______  ,
